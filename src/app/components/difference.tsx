...
const FeatureCard = (props:any) =>{
  return(
    <div className='justify-stretch flex flex-col transition-colors border border-[#01C3F1] rounded-[50px] p-8 xl:pb-24 hover:bg-gradient-to-br from-[#d52bffac] duration-300 ease-in to-[#01c1f1b1] relative overflow-hidden xl:max-h-[400px] gap-5 mb-10 justify-self-stretch'>
      <div className=''>
        <h3 className='font-bold font-primary xl:text-left text-center text-xl xl:text-ellipsis	xl:whitespace-nowrap xl:text-3xl h3Class'>{props.title}</h3>
        <p className='font-normal xl:text-ellipsis mt-5  text-xs xl:text-lg xl:text-left text-center font-secondary xl:w-3/5 xl:h-36'>{props.description}</p>
      </div>
...
export default function difference() {
  ...
  return (
    <div id="features" className='py-12 xl:py-28 '>
      ...
      <div className='pt-6 xl:pt-12  mx-3 xl:mx-20 justify-stretch'>
      <Swiper
        spaceBetween={50}
        observer={true}
        observeParents={true}     
