  ...
  return (
    <div className='flex py-12 xl:py-28 px-3 xl:px-20 max-h-fit iframe-cover flex-col xl:flex-row gap-8 items-start'>
      ...
      <div className='flex justify-evenly flex-col xl:basis-5/12 ml-5'>
        ...
        <a href="https://forms.zohopublic.com/brainchain/form/DextrBetaProgram1/formperma/jwTVjPwh8O2gVFb0TZSSjuBkc-IluEevhgOxTLzDqeY?utm_source=twitter&utm_medium=Zoho+SocialmG" target='_blank' className="xl:self-end xl:w-fit mt-10 text-white buttonNotch3 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-right inline-flex items-center w-3/5 self-center">
          Join Beta
