  ...
  return (
    <div className='flex pt-28 px-20'>
      ...
      <div className='flex justify-between flex-col basis-1/3'>
        ...
        <p className='text-[#ffffffa5] font-secondary text-2xl text-right flex justify-end '>Dextr is a non-custodial exchange <br /> for crypto and real-world   assets powered by Soulbound Tokens ♾️</p>
      </div>
    </div>
  )
}
