  ...
  return (
    <section className='min-h-screen mt-12'>
      ...
      <div className='lg:basis-1/2 flex flex-col justify-center lg:gap-12 gap-5'>
        <div>
          <h1 className='font-primary font-bold text-4xl lg:text-[60px] xl:text-[72px] lg:text-left text-center lg:leading-[50px] xl:leading-[65px]'>Tired of Low Returns and High Slippage?</h1>
        </div>        
        <div>
